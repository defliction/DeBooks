            ...
            <div class ="col-start-2 col-span-3">
                <div class="btn-group ">
                    ...
                    {#if activeChain == "Solana"}
                        <button class="btn btn-ghost bg-zinc-300 btn-xs hover:bg-zinc-300" on:click={() => activeChain = "Solana"}>
                    ...
                    {:else}
                    <button class="btn btn-ghost bg-base-300 btn-xs hover:bg-zinc-300" on:click={() => activeChain = "Solana"}>
                    ...
                    {#if activeChain == "Aptos" && enableAptos}
                        <button class="btn btn-ghost bg-zinc-500 btn-xs hover:bg-zinc-500" on:click={() => activeChain = "Aptos"}>
                    ...
                    {:else if enableAptos}
                    <button class="btn btn-ghost bg-base-300 btn-xs hover:bg-zinc-300 " on:click={() => activeChain = "Aptos"}>
