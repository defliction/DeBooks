                        ...
                        <li class="">
                            <div class="md:tooltip md:tooltip-left z-50" data-tip="About">  
                                ...
                                <button class="btn btn-xs btn-ghost normal-case font-serif">
                                    ...
                                    <a href="https://defliction.medium.com" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
