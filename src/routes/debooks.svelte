...
<div class="flex justify-center font-serif ">
    ...
    <div class="overflow-x-auto relative">
        ...
        <div class="grid grid-flow-col place-items-center pt-4 pb-1">
            {#if !loading } 
                    <div class="col-start-auto">
                        ...
                        <input type="text" placeholder="Search: e.g. Magic Eden..." bind:value={$textFilter} class="input input-xs  max-w-[28rem] " />
                    </div>
        ...
        <table class="flex table table-compact normal-case ">
          ...
          <thead>
            <tr class=" ">
                ...
                <th class="min-w-[12rem] max-w-[28rem] text-left normal-case">Description</th>
                {#if !condition}
          ...
          <tbody>
            ...
            {#each $displayArray.slice(pageIncrement*($currentPage - 1), pageIncrement*($currentPage - 1) + pageIncrement) as transaction, i}
                ...
                <tr class="">
                    ...
                    <td class="whitespace-normal min-w-[12rem] max-w-[28rem] text-left">{transaction.description}</td>
                    {#if !condition}
                    ...
                    {#if showConversion}
                        {#if convertingToReporting} 
                            <td class="min-w-[4rem] text-right"><progress class="progress w-[2rem]"></progress></td>
                        {:else}
                            <td class="min-w-[4rem] text-right">{transaction.usd_amount?.toLocaleString('en-US', { minimumFractionDigits: 2, trailingZeroDisplay :true, maximumFractionDigits: 4 })}</td>
                        {/if}
        ...
        {#if !loading}
        <div class="flex justify-center flex-row pt-10">
            <footer class=" footer px-10 py-4 border-t rounded-md bg-base-200 text-base-content border-base-300 ">
                <div class="items-center grid-flow-col justify-self-start">
                  ...
                  <p>Copyright © 2022 - DeBooks</p>
                </div> 
                <div class="md:place-self-center md:justify-self-end justify-self-center">
