            ...
            <div class ="col-start-2 col-span-3">
                <div class="btn-group ">
                    {#if activeChain == "Solana"}
                        <button class="btn bg-base-primary btn-xs " on:click={() => activeChain = "Solana"}>
                        
                            <svg width="101" height="88" viewBox="0 0 101 88" fill="none" xmlns="http://www.w3.org/2000/svg" class='w-4 h-4'>
