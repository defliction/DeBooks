            ...
            <div class="col-end-9 col-span-1">
                <div class="dropdown dropdown-bottom dropdown-end">
                    ...
                    <ul tabindex="0" class="dropdown-content menu shadow-md border bg-base-100 rounded-box ">
                        ...
                        <li class="">
                            <div class="md:tooltip md:tooltip-left z-50" data-tip="About">  
                               
                                <button class="btn btn-xs btn-ghost normal-case font-serif">
                               
                                    <a href="https://docs.debooks.xyz" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5">
...
<div class="flex justify-center flex-row pt-4">
    <footer class="footer footer-center p-2 text-base-content rounded-md">
        ...
        <p class="font-serif text-sm">DeBooks © 2022 - built by <a class="hover:underline hover:decoration-primary" href="https://www.riparian.one">Riparian, stake with us!</a></p>
        </div>
...
<div class="modal modal-bottom sm:modal-middle">
  <div class="modal-box relative">
    ...
    <div class="prose">
        <em class="text-sm pb-2">last updated: December 2022</em>
        ...
        <span>Contact <a href="https://twitter.com/defliction" target="_blank">@defliction</a> on Twitter or mail <a href="mailto:hello@riparian.one?subject=DeBooks">hello@riparian.one</a> to submit feature requests or anything else</span>
    </div>
